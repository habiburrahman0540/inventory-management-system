        ...
        <div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" @submit.prevent="Customerdataupdate" enctype="multipart/form-data">
						  <fieldset>						
...
export default {
	...
	methods:{
		...
		Customerdataupdate(){
			let id = this.$route.params.id
			axios.patch('/api/all-customer/'+id,this.form)
			.then(()=>{
