        ...
        <div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Employee</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" @submit.prevent="employeedataupdate" enctype="multipart/form-data">
						  <fieldset>						
